...
public class myTestCases extends parameters {
	...
	public void myTest() throws InterruptedException, IOException {
		...
		double firstItems = Double.parseDouble(allPrices.get(0).getText().replace(",", ""));
		double lastItems = Double.parseDouble(allPrices.get(allPrices.size() - 1).getText().replace(",", ""));
